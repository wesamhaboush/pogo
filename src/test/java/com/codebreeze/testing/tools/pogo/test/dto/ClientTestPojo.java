...
public class ClientTestPojo implements Serializable
{
    ...
    {
        final String TAB = "    ";
        String retValue = "ClientTestPojo ( " + TAB + "firstName = " +
                          firstName + TAB + "lastName = " +
                          lastName + TAB + "dateCreated = " +
                          dateCreated + TAB + "dateLastUpdated = " +
                          dateLastUpdated + TAB + "address = " +
                          address + TAB + "bankAccounts = " +
                          bankAccounts + TAB + " )";
        return retValue;
    }
}
