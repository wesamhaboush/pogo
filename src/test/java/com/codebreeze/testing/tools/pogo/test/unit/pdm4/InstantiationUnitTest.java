...
public class InstantiationUnitTest
{
    ...
    public void testPdm4PojoWithSetters()
    {
        ...
        assertEquals( "Invocation order has changed", "int,int", Pdm4PojoWithSetters.invocationOrder.get( 2 ) );
        assertEquals( "Invocation order has changed", "abstract,int", Pdm4PojoWithSetters.invocationOrder.get( 3 ) );
    }
    ...
    public void testPojoWithMultipleNonPublicConstructors()
    {
        ...
        assertEquals( "Invocation order has changed", "no-op",
    ...
    public void testPojoWithFactoryMethods()
    {
        ...
        assertEquals( "Invocation order has changed", "PogoConstructor(str,bool)",
                      PojoWithFactoryMethods.invocationOrder.get( 3 ) );
        assertEquals( "Invocation order has changed", "int,int", PojoWithFactoryMethods.invocationOrder.get( 4 ) );
        assertEquals( "Invocation order has changed", "PogoConstructor(str,abstract)",
                      PojoWithFactoryMethods.invocationOrder.get( 5 ) );
    ...
    public void testPdm4PojoWithFullData()
    {
        ...
        assertNull( "POJO should not be created", pojo );
        assertEquals( "Invocation order has changed", 4, Pdm4PojoWithSetters.invocationOrder.size() );
        assertEquals( "Invocation order has changed", "int,int", Pdm4PojoWithSetters.invocationOrder.get( 0 ) );
        assertEquals( "Invocation order has changed", "abstract,int", Pdm4PojoWithSetters.invocationOrder.get( 1 ) );
    ...
    public void testPojoWithFactoryMethodsWithFullData()
    {
        ...
        assertEquals( "Invocation order has changed", "PogoConstructor(str,abstract)",
                      PojoWithFactoryMethods.invocationOrder.get( 2 ) );
        assertEquals( "Invocation order has changed", "abstract,int", PojoWithFactoryMethods.invocationOrder.get( 3 ) );
        assertEquals( "Invocation order has changed", "PogoConstructor(str)", PojoWithFactoryMethods.invocationOrder.get( 4 ) );
